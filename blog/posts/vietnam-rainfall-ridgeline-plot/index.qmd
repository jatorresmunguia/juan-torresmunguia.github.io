...
I will create two versions of the ridgeline plot. First, a ridgeline plot to show the interquantile range of rainfall by month in [Ha Noi](https://en.wikipedia.org/wiki/Hanoi), capital of Vietnam. Here, the colors represent different quantiles of the distribution of rainfall per month.
```{r}
#| warning: false
#| output: false
